...
import (
	...
	operatorhelper "github.com/calderwd/operator-helper"

	calderwdcomv1 "github.com/calderwd/operator-blog/api/v1"
)
...
//+kubebuilder:rbac:groups=calderwd.com,resources=blogs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=calderwd.com,resources=blogs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=calderwd.com,resources=blogs/finalizers,verbs=update
